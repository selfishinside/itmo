...
public class Vintik extends Essence implements Doingable {

    public Vintik(String name, String mood, int state) {
    ...
    public void toknow(Ponchik ponchik) {
        System.out.println(getName() + " смог добиться что-то от" + ponchik.getName() + "a");
    }
